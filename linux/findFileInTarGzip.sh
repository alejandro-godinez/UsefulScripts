...
#
#Usage:
#  findFileInTarGzip.sh <search> [tgzFilter]
#
#  search    - the text in the files name to search for
#  tgzFilter - additional limit to the list of tgz files that will be searched.
#
#  Example:  findFileInTarGzip.sh test.txt 2018
#   - this will list '*2018*.tar.gz' files and search for entries containing 'test.txt'
#
#-----------------------------------------------------------
